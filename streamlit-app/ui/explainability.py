...
def render_explainability():
    ...
    st.markdown('<div class="card"><div class="card-header">Explainable Risk Insights</div><p style="color:#8b949e; font-size:0.9rem; margin:0;">Contextual breakdown of identified anomalies</p></div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="card"><div class="card-header">Risk Explanations Table</div></div>', unsafe_allow_html=True)
